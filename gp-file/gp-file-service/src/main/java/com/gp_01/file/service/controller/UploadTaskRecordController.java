...
public class UploadTaskRecordController {
    ...
    public Result<UploadTaskRecord> createUploadTaskRecord(@RequestBody CreateUploadTaskRecordDTO dto){
        UploadTaskRecord res = uploadTaskRecordService.createUploadTaskRecord(dto);
